...
import { MapPin, Phone, MessageCircle, Mail, Clock, Users, Lightbulb, Target } from "lucide-react";
...
I would like to know more about the admission process and course details.`;
    ...
    // Updated phone number to 9289071052
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-2xl mx-auto leading-relaxed">
            Ready to illuminate your academic path? Get in touch for admissions, course details, and personalized guidance.
          </p>
        </div>
